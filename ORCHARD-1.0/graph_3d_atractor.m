...
% -----------------------------------------------------------------
function fig = graph_3d_atractor(x1,y1,z1,time,gtitle,xlab,ylab,zlab,...
    ...
    % time display
    th = text(0.8,0.95,'',... %['time = ',num2str(time(1),'%.1f'),' sec']
                         'Color','k','FontName',...
    ...
    zlabel(zlab,'FontSize',20,'FontName','Helvetica');

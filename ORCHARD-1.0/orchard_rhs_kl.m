...
%  Ye1        - left tire displacement
%  Ye2        - right tire displacement
%  Ye1_dot    - left tire velocity
%  Ye2_dot    - right tire velocity
%  
%  Output:
...
% -----------------------------------------------------------------
function qdot = orchard_rhs_kl(t,q,phys_param,...
                                   Ye1,Ye2,Ye1_dot,Ye2_dot,time)
% physical parameters
kt  = phys_param(1);
ct  = phys_param(2);
k1  = phys_param(3);
...
% time-dependent external excitation
ye1 = interp1(time,Ye1,t,'linear');
ye2 = interp1(time,Ye2,t,'linear');

% time-dependent external excitation time derivative
ye1_dot = interp1(time,Ye1_dot,t,'linear');
ye2_dot = interp1(time,Ye2_dot,t,'linear');


% auxiliar variables 
% (save floating point operations)
sin_phi1 = sin(phi1);
cos_phi1 = cos(phi1);
sin_phi2 = sin(phi2);
cos_phi2 = cos(phi2);
...
G(2,1) = (k1*B1*B1+k2*B2*B2)*sin_phi1*cos_phi1 - m2*g*L1*sin_phi1;
